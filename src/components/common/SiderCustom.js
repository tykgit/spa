            ...
            >
                ...
                >
                    ...
                    <Menu.Item key={"/app/form"}>
                        <Link to={"/app/form"}><Icon type="appstore" /><span>海报</span></Link>
                    </Menu.Item>
                    <SubMenu
                    key="/app/detail"
                    title={<span><Icon type="file-text" /><span>详情</span></span>}
                    >
                        <Menu.Item key="/app/detail/dateilList">
                            <Link to={'/app/detail/dateilList'}><span>表格详情</span></Link>
                        </Menu.Item>
                    </SubMenu>

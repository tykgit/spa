...
import { Row, Modal, Pagination, List, Col, Input, Icon, Cascader, DatePicker, Button, Card, Checkbox, Radio } from 'antd';
const { Meta } = Card;
            ...
            <div>
                ...
                <div className='formBody'>
                    ...
                    >
                        ...
                        />
                        <Button type="primary" style={{marginTop:20,float:'left'}} onClick={e=>this.showModal(item)}>同意</Button>
                        <Button type="danger" style={{marginTop:20,float:'right'}} onClick={e=>this.showModal(item)}>不同意</Button>
                    </Card>
                        </List.Item>
                        )}
                    />
                    <div style={{overflow: 'hidden'}}>
                        <Pagination showSizeChanger defaultCurrent={3} total={500} style={{float:'right'}}/>  
                    </div>
                </div>
                <Modal
                    title="Basic Modal"
